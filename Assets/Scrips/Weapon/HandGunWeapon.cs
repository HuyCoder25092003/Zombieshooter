...
public class HandGunWeapon : WeaponBehaviour
{
    public override void Init()
    {
        iWeaponHandle = new IHandGun();
...
public class IHandGun : IWeaponHandle
{
    ...
    void CreateBullet()
    {
        ...
        Bulletdata bulletdata = new Bulletdata { damage = 2, name_pool = wp.name_bullet_pool };
